...
/**
 * @name    User button on octa
 * @{
 */
#define BTN1_PIN            GPIO_PIN(PORT_G, 0)
 ...
 * @{
 */
#define BTN2_PIN            GPIO_PIN(PORT_G, 1)
 ...
 * @{
 */
#define INT_1           GPIO_PIN(PORT_B, 13)
#define INT_2           GPIO_PIN(PORT_A, 5)       
/** @} */
 ...
 * @{
 */
#define INT_MAG         GPIO_PIN(PORT_B, 12)         
/** @} */
