...
def parse_alp(raw):
    ...
    message = message.split('ReturnFileData: ')[
        1]  # remove 'Command with tag xxx (executing)\n\tactions:\n\t\taction: ReturnFileData: ' at front of string
    ...
    # print('data',data)
    message = message.split('[')[0][:-7] + message.split(']')[1]  # cleaning up after data extraction
